...
#               break
            ...
            try:
                ...
                if all(field in json_data for field in ['CodigoCurso', 'CodigoDisciplina', 'Periodo', 'Matricula', 'Nota', 'Frequencia', 'Status','MotivoReprovacao']):
...
if dados_alunos:
    ...
    arquivo_local = f'/usr/local/datasets/dados_alunos_cursos_disciplinas_{current_time}.csv'
    arquivo_datalake = f'raw/dados_alunos_cursos_disciplinas/dados_alunos_cursos_disciplinas_{current_time}.csv'
